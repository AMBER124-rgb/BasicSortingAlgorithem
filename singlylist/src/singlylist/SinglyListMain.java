...
//		System.out.println("Trav is : "+trav);
//		System.out.println("Trav Data is : "+trav.data);
//		System.out.println("Trav Next is : "+trav.next);
		while(trav != null) {
//			System.out.println("#####################################################################");
//			System.out.println("Trav is : "+trav);
//			System.out.println("Trav Data is : "+trav.data);
...
//			System.out.println("############## #######################################################");
	...
	void addFirst(int val) {
		...
		//Special case =1 : if list is empty,first node is itself is the last node
		if(head==null)
			tail=newNode;
...
//			trav.next = newNode;
			...
			//add newNode to the next of last node(tail)
			tail.next=newNode;
